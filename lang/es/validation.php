...
return [
    ...
    */
    ...
    | utilizando el formato "atributo.regla" para definir las líneas personalizadas.
    |
    */
    ...
    | en lugar de "email". Esto simplemente nos ayuda a hacer el mensaje un poco 
    | más claro.
    |
    */
